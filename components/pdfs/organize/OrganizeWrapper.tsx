...
const OrganizeWrapper: FC = () => {
    ...
    const handleDeletePage = (index: number) => {
        setPages((prev) => prev.map((page, i) => (i === index ? { ...page, deleted: !page.deleted } : page)))
    }
        ...
        >
            ...
            {processedUrl && (
                <div className="text-center py-8">
                    ...
                    <h3 className="text-xl font-semibold mb-2">PDF Organized Successfully!</h3>
                    <p className="text-muted-foreground mb-6">Your organized PDF is ready to download.</p>
