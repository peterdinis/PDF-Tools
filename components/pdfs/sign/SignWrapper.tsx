      ...
      {files.length > 0 && !signed && (
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-muted-foreground">Draw your signature with your mouse or touchpad</p>
          </div>
          <Button
            onClick={handleSign}
      ...
      {signed && (
        <div className="space-y-4">
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-green-800 font-medium">PDF signed successfully!</p>
            <p className="text-sm text-green-700 mt-1">Your signature has been added to the last page</p>
          </div>
