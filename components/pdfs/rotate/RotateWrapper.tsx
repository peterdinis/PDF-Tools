        ...
        <CardContent className="p-6">
          {!rotatedPdf ? (
            <>
              ...
              {files.length > 0 && (
                <div className="mt-6 space-y-6">
                  <div>
                    <Label className="text-base font-semibold mb-3 block">Rotation Angle</Label>
                    <RadioGroup
                      value={rotationAngle.toString()}
                      onValueChange={(value) => setRotationAngle(Number.parseInt(value) as RotationAngle)}
                    >
                      <div className="flex items-center space-x-2 mb-2">
                        <RadioGroupItem value="90" id="90" />
                        <Label htmlFor="90" className="font-normal cursor-pointer">
                          90° clockwise
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2 mb-2">
                        <RadioGroupItem value="180" id="180" />
                        <Label htmlFor="180" className="font-normal cursor-pointer">
                          180° (upside down)
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="270" id="270" />
                        <Label htmlFor="270" className="font-normal cursor-pointer">
                  ...
                  <div className="p-4 bg-secondary rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">All pages will be rotated {rotationAngle}°</p>
                    </div>
                  </div>
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold mb-2">PDF Rotated Successfully!</h3>
              <p className="text-muted-foreground mb-6">Your rotated PDF is ready to download.</p>
