        ...
        <CardContent className="p-6">
          {!protectedPdf ? (
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div className="p-4 bg-secondary rounded-lg">
                    <p className="text-sm text-muted-foreground">
                      Your PDF will be encrypted with the password you provide. Make sure to remember it!
                    </p>
                  </div>
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold mb-2">PDF Protected Successfully!</h3>
              <p className="text-muted-foreground mb-6">Your password-protected PDF is ready to download.</p>
