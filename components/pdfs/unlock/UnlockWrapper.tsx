...
const UnlockWrapper: FC = () => {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      setError("Failed to unlock PDF. The file may be encrypted with a strong password or corrupted.")
    } finally {
      setProcessing(false)
    }
  }
        ...
        <div className="space-y-4">
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg flex gap-3">
            ...
            <div className="text-sm text-blue-800">
              ...
              <p className="mt-1">
                This tool can remove basic restrictions but may not work with strongly encrypted PDFs. For best results,
                use PDFs with user-level passwords.
              </p>
            </div>
          </div>
      ...
      {processed && (
        <div className="space-y-4">
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-green-800 font-medium">PDF unlocked successfully!</p>
            <p className="text-sm text-green-700 mt-1">Password protection has been removed</p>
          </div>
