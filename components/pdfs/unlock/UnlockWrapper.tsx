  ...
  const handleUnlock = async () => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        setError(
          result.error || "Failed to unlock PDF. Please check your password.",
        );
      }
    } catch (err) {
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <Alert className="bg-yellow-50 border-yellow-200">
                    ...
                    <AlertDescription className="text-yellow-800">
                      <strong>Important:</strong> You must know the password to
                      unlock the document. This tool does not bypass security
