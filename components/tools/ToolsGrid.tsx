...
const tools = [
  ...
  {
    name: "Repair PDF",
    description: "Repair a damaged PDF and recover data from corrupt PDF. Fix PDF files with our Repair PDF tool.",
    icon: FileCheck,
    href: "/repair",
    color: "text-orange-500",
  },
  {
    name: "Scan to PDF",
    description: "Capture document scans from any mobile device and automatically convert them to PDF files.",
    icon: ScanLine,
    href: "/scan",
    color: "text-blue-500",
  },
  ...
  {
    name: "Reduce PDF",
    description: "Reduce file size and optimize PDF documents to decrease file size.",
    icon: Minimize2,
    href: "/reduce",
    color: "text-green-500",
  },
  {
    name: "Extract PDF",
    description: "Extract images, text and pages from PDF files. Get all the data you need from your PDF.",
    icon: FileDown,
    href: "/extract",
